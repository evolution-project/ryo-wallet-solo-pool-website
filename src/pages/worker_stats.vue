...
<q-page>
    <div class="q-pa-md">
        ...
        <div v-if="worker.account.address == ''">
            ...
            <p>Enter your public Evolution address and private viewkey and we will scan the solo-mined blocks to check which ones are yours. You will be able to see your estimated hashrate, total amount mined, including pending and unlocked funds. You may select "Remember me" in order to save your address and viewkey to the local browser storage.</p>
